import { EventStatus, QuotationStatus } from "@prisma/client";
...
export interface AssistedDashboard {
  ...
  upcomingEvents: Array<{ id: string; name: string; startAt: string; status: EventStatus; route: string }>;
  pendingQuotations: Array<{ id: string; number: string; validUntil: string; status: QuotationStatus; clientName: string; route: string }>;
