...
class AppComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AppComponent, selectors: [["kaklen-root"]], decls: 9, vars: 0, consts: [[1, "topbar"], ["routerLink", "/dashboard", 1, "brand"], ["aria-label", "Primary"], ["routerLink", "/login"], ["routerLink", "/register"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src/main.ts", lineNumber: 34 }); })();
