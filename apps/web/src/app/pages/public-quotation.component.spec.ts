...
function view(options: {
  ...
  return {
    ...
    quotation: {
      ...
      notes: null,
      terms: null,
      items: [{ index: 0, code: "SERV-1", name: "Service", description: null, quantity: "1", unit: "unit", unitPrice: "1000", discountType: "NONE", discountValue: "0", taxPercent: "19", subtotal: "1000", lineDiscountTotal: "0", globalDiscountTotal: "0", discountTotal: "0", taxableBase: "1000", taxTotal: "190", total: "1190" }],
      history: []
    },
