...
const translations = {
  en: {
    ...
    clientProgressLabel: "Client progress", clientStepIdentity: "Type and identification", clientStepContact: "Contact details", clientStepAddress: "Address", clientStepReview: "Review", clientReviewHelp: "Confirm the main information. You can complete or edit the details later.", saveBasicClientButton: "Save basic details", clientStepValidationError: "Complete the required fields in this step to continue.",
