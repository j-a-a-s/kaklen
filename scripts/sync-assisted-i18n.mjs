...
const translations = {
  en: {
    ...
    quantityTimesPriceLabel: "Quantity × price",
    lineNetLabel: "Net",
    lineDiscountLabel: "Line discount",
    allocatedGlobalDiscountLabel: "Allocated overall discount",
    lineTaxLabel: "VAT",
    lineTotalVatIncludedLabel: "Line total, VAT included",
    netSubtotalLabel: "Net subtotal",
    lineDiscountTotalLabel: "Line discounts",
    globalDiscountTotalLabel: "Overall discount",
    totalDiscountLabel: "Total discount",
    taxableBaseLabel: "Taxable base",
    quotationChangesRequestedBannerTitle: "The customer requested changes",
    quotationChangesRequestedBannerBody: "Review their comments before creating a new version.",
    ...
    changeRequestNoItems: "No specific items were selected.",
    changeRequestMetadata: "Version {$quotationVersion} · Sent {$createdAt}",
    approvedOtherCurrenciesLabel: "Other approved currencies",
  ...
  "pt-BR": {
    ...
    quantityTimesPriceLabel: "Quantidade × preço",
    lineNetLabel: "Líquido",
    ...
    lineDiscountTotalLabel: "Descontos por item",
    globalDiscountTotalLabel: "Desconto global",
    totalDiscountLabel: "Desconto total",
    taxableBaseLabel: "Base tributável",
    quotationChangesRequestedBannerTitle: "O cliente solicitou alterações",
    quotationChangesRequestedBannerBody: "Revise os comentários antes de criar uma nova versão.",
    ...
    changeRequestNoItems: "Nenhum item específico foi selecionado.",
    changeRequestMetadata: "Versão {$quotationVersion} · Enviada em {$createdAt}",
    approvedOtherCurrenciesLabel: "Outras moedas aprovadas",
